...
void BuildMultiShotDataset(const char* originalRootFile,  const int numShots, const int iterations=1){
    ...
    tree->Branch("distr", &(dist[numFixedEntries]), "distr[n]/F");
    tree->Branch("dr2", &(d2[numFixedEntries]), "dr2[n]/F");
    tree->Branch("dr3", &(d3[numFixedEntries]), "dr3[n]/F");
    tree->Branch("xr1", &(x1[numFixedEntries]), "xr1[n]/F");
    tree->Branch("yr1", &(y1[numFixedEntries]), "yr1[n]/F");
    tree->Branch("xr2", &(x2[numFixedEntries]), "xr2[n]/F");
    tree->Branch("yr2", &(y2[numFixedEntries]), "yr2[n]/F");
    tree->Branch("sr1", &(s1[numFixedEntries]), "sr1[n]/F");
    tree->Branch("sr2", &(s2[numFixedEntries]), "sr2[n]/F");
